...
<!--Nav end-->
  ...
  <div class="row">
    <div class="col"><a class="btn btn-secondary btn-lg btn-block tl" href="message.php">Send Message</a></div>
    <div class="col"> <a class="btn btn-secondary btn-lg btn-block tl" href="null.php">Feedback</a></div>
    <br>
  </div>
  <br>
  <div class="footer">
