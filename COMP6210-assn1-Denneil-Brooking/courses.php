...
<nav class="navbar navbar-light bg-light navcon justify-content-center">
    <form class="form-inline">
        <div class="row">
            ...
            <div class="col- bt1 ccl">
                <a class="btn btn-sm btn-outline-secondary bt bt2 active" href="courses.php">Courses</a>
            </div>
            <div class="col-">
...
<!--Nav end-->
  <br>
  <div class="row">
    <div class="col"><a class="btn btn-secondary btn-lg btn-block tl" href="null.php">COMP6209</a></div>
    <div class="col"> <a class="btn btn-secondary btn-lg btn-block tl" href="null.php">COMP6210</a></div>
    <div class="col"><a class="btn btn-secondary btn-lg btn-block tl" href="null.php">COMP6211</a></div>
    <div class="col"><a class="btn btn-secondary btn-lg btn-block tl" href="null.php">COMP6212</a></div>
  </div>
