    ...
    <form class="form-inline">
        <div class="row">
            ...
            <div class="col- bt2 ccl">
                <a class="btn btn-sm btn-outline-secondary bt bt2 active" href="projects.php">Learning</a>
            </div>
        </div>
    </form>
</nav>
<!--Nav end-->
    ...
    <div class="row">
      <div class="col"><a class="btn btn-secondary btn-lg btn-block tl" href="null.php">Projects</a></div>
      <div class="col"> <a class="btn btn-secondary btn-lg btn-block tl" href="log.php">Learning Log</a></div>
      <br>
    </div>
    <br>
    <div class="footer">
